...
export function buildLocationAnalysisUserPrompt(
  ...
  return [
    ...
    'Los tags son secundarios. Elegí pocos tags y solo cuando describan elementos visuales distintivos y realmente útiles para búsqueda, como materiales, ventanales, luz natural, piscina, jardín, columnas o chimenea.',
    'No selecciones mobiliario común como tag solo por aparecer en las imágenes. Mesa, sofá, sillón, escritorio, estanterías, biblioteca o taburetes normalmente deben quedar en description salvo que sean excepcionalmente protagonistas.',
